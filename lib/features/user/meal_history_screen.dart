...
// CardInteraction intentionally not used in meal list items per guidelines
          ...
          if (items.isEmpty) {
            return const Center(
              child: EmptyStateView(
                ...
                subtitle: 'Start scanning meals to build your history.',
